...
var itemsAmount = 20;
function preload(){
    game.load.image('sky', 'source/bg3.jpg');
...
function create(){
    ...
    var ledge = platforms.create(607, 258, 'step');
    ledge.body.immovable = true;
    ledge = platforms.create(-150, 579, 'step');
    ledge.body.immovable = true;
    ledge = platforms.create(297, 288, '200step');
    ledge.body.immovable = true;
    ledge = platforms.create(630, 600, '200step');
    ledge.body.immovable = true;
    ledge = platforms.create(290, 520, 'step');
    ledge.body.immovable = true;
    ledge = platforms.create(130, 420, 'smallStep');
    ledge.body.immovable = true;
    ledge = platforms.create(0, 270, 'middleStep');
    ledge.body.immovable = true;
    ledge = platforms.create(400, 170, 'middleStep');
    ledge.body.immovable = true;
    ledge = platforms.create(680, 90, 'middleStep');
    ledge.body.immovable = true;
    ledge = platforms.create(100, 130, 'smallStep');
    ledge.body.immovable = true;
    ledge = platforms.create(230, 100, 'smallStep');
    ledge.body.immovable = true;
    ...
    {
        var banana = bananas.create(i * Math.floor(Math.random()*(40-35) + 35), 0, 'banana');
    ...
    timerText = game.add.text(480, 0, 'Time: 40', {fontSize:'32px', fill: '#CCC'});
...
function collectStar (player, banana) {
    ...
    if (score === itemsAmount*10){
        ...
        setTimeout(changeLevel('http://captainblack.epizy.com/levels/5mobile.html'),3000);
    }
}
...
function updateCounter() {
    if (time == 0) {
        ...
        setTimeout(changeLevel('http://captainblack.epizy.com/levels/4mobile.html'),5000);
    }
    else {
        time--;
